...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    title: { default: "averagedayinamerica Wiki", template: "%s" },
    description: "Complete Average Day In America fan wiki with weapons, jobs, map locations, guides and controls.",
